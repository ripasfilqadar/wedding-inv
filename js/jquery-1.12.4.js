...
! function(e, t) {
    ...
    p.fn = p.prototype = {
        ...
        var e, t, n, r, i, o, a = arguments[0] || {},
            ...
            l = arguments.length,
            u = !1;
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || p.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
    ...
    var x = function(e) {
        var t, n, r, i, o, a, s, l, u, c, f, d, p, h, g, m, v, y, x, b = "sizzle" + 1 * new Date,
            w = e.document,
            T = 0,
            C = 0,
            E = oe(),
        ...
        function ie(e, t, r, i) {
            var o, s, u, c, f, h, v, y, T = t && t.ownerDocument,
                C = t ? t.nodeType : 9;
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [a ? m.firstChild : m.lastChild], a && y) {
                                for (x = (p = (u = (c = (f = (d = m)[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === T && u[1]) && u[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (x = p = 0) || h.pop();)
                                    if (1 === d.nodeType && ++x && d === t) {
                                        c[e] = [T, p, x];
                                        break
                                    }
                            } else if (y && (x = p = (u = (c = (f = (d = t)[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === T && u[1]), !1 === x)
                                for (;
        ...
        function me(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (a) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                            if ((s = (l = (u = t[b] || (t[b] = {}))[t.uniqueID] || (u[t.uniqueID] = {}))[r]) && s[0] === T && s[1] === o) return c[2] = s[2];
        ...
        function xe(e, t, n, r, i, o) {
            return r && !r[b] && (r = xe(r)), i && !i[b] && (i = xe(i, o)), ae(function(o, a, s, l) {
                var u, c, f, d = [],
                    p = [],
                    h = a.length,
                    g = o || function(e, t, n) {
                    ...
                    v = n ? i || (o ? e : h || r) ? [] : a : m;
                if (n && n(m, v, s, l), r)
                    for (u = ye(v, p), r(u, [], s, l), c = u.length; c--;)(f = u[c]) && (v[p[c]] = !(m[p[c]] = f));
                if (o) {
                    if (i || e) {
                        if (i) {
                        ...
                        for (c = v.length; c--;)(f = v[c]) && (u = i ? F(o, f) : d[c]) > -1 && (o[u] = !(a[u] = f))
                    }
            ...
            for (var t, n, i, o = e.length, a = r.relative[e[0].type], s = a || r.relative[" "], l = a ? 1 : 0, c = me(function(e) {
                ...
                if (n = r.relative[e[l].type]) d = [me(ve(d), n)];
                    ...
                    if ((n = r.filter[e[l].type].apply(null, e[l].matches))[b]) {
                        ...
                        return xe(l > 1 && ve(d), l > 1 && ge(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(I, "$1"), n, l < i && be(e.slice(l, i)), i < o && be(e = e.slice(i)), i < o && ge(e))
                    }
                    d.push(n)
                }
            return ve(d)
        ...
        return he.prototype = r.filters = r.pseudos, r.setFilters = new he, a = ie.tokenize = function(e, t) {
            ...
            if (!m) {
                ...
                (m = k(e, (i = h, s = (o = f).length > 0, l = i.length > 0, c = function(e, t, n, a, c) {
                    var f, h, m, v = 0,
                        y = "0",
                        x = e && [],
                        b = [],
                        ...
                        N = C.length;
                    for (c && (u = t === p || t || c); y !== N && null != (f = C[y]); y++) {
                        if (l && f) {
    ...
    p.Callbacks = function(e) {
            ...
            f = {
                ...
                remove: function() {
                    return p.each(arguments, function(e, t) {
                        for (var n;
                            (n = p.inArray(t, s, n)) > -1;) s.splice(n, 1), n <= u && u--
                    }), this
                },
                has: function(e) {
        ...
        when: function(e) {
            ...
            if (s > 1)
                for (t = new Array(s), n = new Array(s), r = new Array(s); o < s; o++) a[o] && p.isFunction(a[o].promise) ? a[o].promise().progress(c(o, n, t)).done(c(o, r, a)).fail(u.reject) : --l;
    ...
    function fe(e, t, n, r, i) {
        for (var o, a, s, l, u, c, d, h = e.length, g = ie(t), m = [], v = 0; v < h; v++)
            if ((a = e[v]) || 0 === a)
                if ("object" === p.type(a)) p.merge(m, a.nodeType ? [a] : a);
                else if (le.test(a)) {
            for (l = l || g.appendChild(t.createElement("div")), u = (ee.exec(a) || ["", ""])[1].toLowerCase(), d = oe[u] || oe._default, l.innerHTML = d[1] + p.htmlPrefilter(a) + d[2], o = d[0]; o--;) l = l.lastChild;
            if (!f.leadingWhitespace && ne.test(a) && m.push(t.createTextNode(ne.exec(a)[0])), !f.tbody)
                for (o = (a = "table" !== u || ue.test(a) ? "<table>" !== d[1] || ue.test(a) ? 0 : l : l.firstChild) && a.childNodes.length; o--;) p.nodeName(c = a.childNodes[o], "tbody") && !c.childNodes.length && a.removeChild(c);
            for (p.merge(m, l.childNodes), l.textContent = ""; l.firstChild;) l.removeChild(l.firstChild);
            l = g.lastChild
        } else m.push(t.createTextNode(a));
        for (l && g.removeChild(l), f.appendChecked || p.grep(ae(m, "input"), ce), v = 0; a = m[v++];)
            if (r && p.inArray(a, r) > -1) i && i.push(a);
            else if (s = p.contains(a.ownerDocument, a), l = ae(g.appendChild(a), "script"), s && se(l), n)
    ...
    p.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, a, s, l, u, c, f, d, h, g, m, v = p._data(e);
            if (v) {
                for (n.handler && (n = (l = n).handler, i = l.selector), n.guid || (n.guid = p.guid++), (a = v.events) || (a = v.events = {}), (c = v.handle) || ((c = v.handle = function(e) {
                    ...
                    }).elem = e), s = (t = (t || "").match(q) || [""]).length; s--;) h = m = (o = me.exec(t[s]) || [])[1], g = (o[2] || "").split(".").sort(), h && (u = p.event.special[h] || {}, h = (i ? u.delegateType : u.bindType) || h, u = p.event.special[h] || {}, f = p.extend({
                    type: h,
                    origType: m,
                    data: r,
                    handler: n,
                    ...
                    namespace: g.join(".")
                }, l), (d = a[h]) || ((d = a[h] = []).delegateCount = 0, u.setup && !1 !== u.setup.call(e, r, g, c) || (e.addEventListener ? e.addEventListener(h, c, !1) : e.attachEvent && e.attachEvent("on" + h, c))), u.add && (u.add.call(e, f), f.handler.guid || (f.handler.guid = n.guid)), i ? d.splice(d.delegateCount++, 0, f) : d.push(f), p.event.global[h] = !0);
                e = null
            }
        },
        remove: function(e, t, n, r, i) {
            var o, a, s, l, u, c, f, d, h, g, m, v = p.hasData(e) && p._data(e);
            if (v && (c = v.events)) {
                for (u = (t = (t || "").match(q) || [""]).length; u--;)
                    if (h = m = (s = me.exec(t[u]) || [])[1], g = (s[2] || "").split(".").sort(), h) {
                        for (f = p.event.special[h] || {}, d = c[h = (r ? f.delegateType : f.bindType) || h] || [], s = s[2] && new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = d.length; o--;) a = d[o], !i && m !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (d.splice(o, 1), a.selector && d.delegateCount--, f.remove && f.remove.call(e, a));
                        l && !d.length && (f.teardown && !1 !== f.teardown.call(e, g, v.handle) || p.removeEvent(e, h, v.handle), delete c[h])
                    } else
        ...
        trigger: function(t, n, i, o) {
            var a, s, l, u, f, d, h, g = [i || r],
                m = c.call(t, "type") ? t.type : t,
                v = c.call(t, "namespace") ? t.namespace.split(".") : [];
            if (l = d = i = i || r, 3 !== i.nodeType && 8 !== i.nodeType && !ge.test(m + p.event.triggered) && (m.indexOf(".") > -1 && (m = (v = m.split(".")).shift(), v.sort()), s = m.indexOf(":") < 0 && "on" + m, (t = t[p.expando] ? t : new p.Event(m, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = v.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : p.makeArray(n, [t]), f = p.event.special[m] || {}, o || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                if (!o && !f.noBubble && !p.isWindow(i)) {
                    for (u = f.delegateType || m, ge.test(u + m) || (l = l.parentNode); l; l = l.parentNode) g.push(l), d = l;
                    d === (i.ownerDocument || r) && g.push(d.defaultView || d.parentWindow || e)
                }
                for (h = 0;
                    (l = g[h++]) && !t.isPropagationStopped();) t.type = h > 1 ? u : f.bindType || m, (a = (p._data(l, "events") || {})[t.type] && p._data(l, "handle")) && a.apply(l, n), (a = s && l[s]) && a.apply && O(l) && (t.result = a.apply(l, n), !1 === t.result && t.preventDefault());
            ...
            if (l[0] = e, e.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, e)) {
                for (s = p.event.handlers.call(this, e, u), t = 0;
                    ...
                    for (e.currentTarget = o.elem, n = 0;
                        (a = o.handlers[n++]) && !e.isImmediatePropagationStopped();) e.rnamespace && !e.rnamespace.test(a.namespace) || (e.handleObj = a, e.data = a.data, void 0 !== (r = ((p.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, l)) && !1 === (e.result = r) && (e.preventDefault(), e.stopPropagation()));
            ...
            if (s && l.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
                        for (r = [], n = 0; n < s; n++) void 0 === r[i = (o = t[n]).selector + " "] && (r[i] = o.needsContext ? p(i, this).index(l) > -1 : p.find(i, this, null, [l]).length), r[i] && r.push(o);
                        r.length && a.push({
                            elem: l,
                            handlers: r
                        })
    ...
    function _e(e, t, n, r) {
        ...
        if (h && (i = (c = fe(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === c.childNodes.length && (c = i), i || r)) {
            for (s = (l = p.map(ae(c, "script"), je)).length; d < h; d++) a = c, d !== g && (a = p.clone(a, !0, !0), s && p.merge(l, ae(a, "script"))), n.call(e[d], a, d);
            if (s)
                for (u = l[l.length - 1].ownerDocument, p.map(l, Le), d = 0; d < s; d++) a = l[d], te.test(a.type || "") && !p._data(a, "globalEval") && p.contains(u, a) && (a.src ? p._evalUrl && p._evalUrl(a.src) : p.globalEval((a.text || a.textContent || a.innerHTML || "").replace(Se, "")));
            c = i = null
        }
        return e
    }
    ...
    p.extend({
        ...
        clone: function(e, t, n) {
            ...
            return (r = ae(o, "script")).length > 0 && se(r, !l && ae(e, "script")), r = s = i = null, o
        },
        cleanData: function(e, t) {
            for (var r, i, o, a, s = 0, l = p.expando, u = p.cache, c = f.attributes, d = p.event.special; null != (r = e[s]); s++)
                if ((t || O(r)) && (a = (o = r[l]) && u[o])) {
                    if (a.events)
                        for (i in a.events) d[i] ? p.event.remove(r, i) : p.removeEvent(r, i, a.handle);
                    u[o] && (delete u[o], c || void 0 === r.removeAttribute ? r[l] = void 0 : r.removeAttribute(l), n.push(o))
                }
        }
    }), p.fn.extend({
        domManip: _e,
    ...
    ! function() {
        ...
        function c() {
            ...
            d.appendChild(l), u.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", t = i = s = !1, n = a = !0, e.getComputedStyle && (f = e.getComputedStyle(u), t = "1%" !== (f || {}).top, s = "2px" === (f || {}).marginLeft, i = "4px" === (f || {
                width: "4px"
            }).width, u.style.marginRight = "50%", n = "4px" === (f || {
                marginRight: "4px"
            }).marginRight, (c = u.appendChild(r.createElement("div"))).style.cssText = u.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", c.style.marginRight = c.style.width = "0", u.style.width = "1px", a = !parseFloat((e.getComputedStyle(c) || {}).marginRight), u.removeChild(c)), u.style.display = "none", (o = 0 === u.getClientRects().length) && (u.style.display = "", u.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", u.childNodes[0].style.borderCollapse = "separate", (c = u.getElementsByTagName("td"))[0].style.cssText = "margin:0;border:0;padding:0;display:none", (o = 0 === c[0].offsetHeight) && (c[0].style.display = "", c[1].style.display = "none", o = 0 === c[0].offsetHeight)), d.removeChild(l)
        }
        u.style && (u.style.cssText = "float:left;opacity:.5", f.opacity = "0.5" === u.style.opacity, f.cssFloat = !!u.style.cssFloat, u.style.backgroundClip = "content-box", u.cloneNode(!0).style.backgroundClip = "", f.clearCloneStyle = "content-box" === u.style.backgroundClip, (l = r.createElement("div")).style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", u.innerHTML = "", l.appendChild(u), f.boxSizing = "" === u.style.boxSizing || "" === u.style.MozBoxSizing || "" === u.style.WebkitBoxSizing, p.extend(f, {
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = p.camelCase(t),
                    l = e.style;
                if (t = p.cssProps[s] || (p.cssProps[s] = nt(s) || s), a = p.cssHooks[t] || p.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
                if ("string" === (o = typeof n) && (i = X.exec(n)) && i[1] && (n = Y(e, t, i), o = "number"), null != n && n == n && ("number" === o && (n += i && i[3] || (p.cssNumber[s] ? "" : "px")), f.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, r))))) try {
                    l[t] = n
                } catch (e) {}
            }
        },
    ...
    var lt, ut, ct, ft, dt, pt, ht, gt = /^(?:toggle|show|hide)$/,
        mt = /queueHooks$/;
    ...
    function bt(e, t, n) {
        var r, i, o = 0,
            ...
            l = function() {
                if (i) return !1;
                for (var t = lt || vt(), n = Math.max(0, u.startTime + u.duration - t), r = 1 - (n / u.duration || 0), o = 0, a = u.tweens.length; o < a; o++) u.tweens[o].run(r);
        ...
        for (! function(e, t) {
            ...
            if (r = bt.prefilters[o].call(u, e, c, u.opts)) return p.isFunction(r.stop) && (p._queueHooks(u.elem, u.opts.queue).stop = p.proxy(r.stop, r)), r;
        return p.map(c, xt, u), p.isFunction(u.opts.start) && u.opts.start.call(e, u), p.fx.timer(p.extend(l, {
            elem: e,
            anim: u,
            queue: u.opts.queue
    ...
    p.Animation = p.extend(bt, {
        ...
        prefilters: [function(e, t, n) {
            var r, i, o, a, s, l, u, c = this,
                ...
                g = e.nodeType && V(e),
                m = p._data(e, "fxshow");
            n.queue || (null == (s = p._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, l = s.empty.fire, s.empty.fire = function() {
                s.unqueued || l()
            }), s.unqueued++, c.always(function() {
                c.always(function() {
                    s.unqueued--, p.queue(e, "fx").length || s.empty.fire()
                })
            })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], "inline" === ("none" === (u = p.css(e, "display")) ? p._data(e, "olddisplay") || Pe(e.nodeName) : u) && "none" === p.css(e, "float") && (f.inlineBlockNeedsLayout && "inline" !== Pe(e.nodeName) ? h.zoom = 1 : h.display = "inline-block")), n.overflow && (h.overflow = "hidden", f.shrinkWrapBlocks() || c.always(function() {
            ...
            if (p.isEmptyObject(d)) "inline" === ("none" === u ? Pe(e.nodeName) : u) && (h.display = u);
            else {
        ...
        var e, t = p.timers,
            n = 0;
        for (lt = p.now(); n < t.length; n++)(e = t[n])() || t[n] !== e || t.splice(n--, 1);
            ...
            select: {
                get: function(e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || i < 0, a = o ? null : [], s = o ? i + 1 : r.length, l = i < 0 ? s : o ? i : 0; l < s; l++)
                        if (((n = r[l]).selected || l === i) && (f.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !p.nodeName(n.parentNode, "optgroup"))) {
    ...
    p.extend({
        ...
        ajax: function(t, n) {
            ...
            var r, i, o, a, s, l, u, c, f = p.ajaxSetup({}, n),
                d = f.context || f,
            ...
            function C(t, n, r, i) {
                var c, y, x, w, C, E = n;
                2 !== b && (b = 2, s && e.clearTimeout(s), u = void 0, a = i || "", T.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, r && (w = function(e, t, n) {
    ...
    p.param = function(e, t) {
        ...
        return this.isLocal ? ln() : r.documentMode > 8 ? sn() : /^(get|post|head|put|delete|options)$/i.test(this.type) && sn() || ln()
    } : sn;
    var rn = 0,
        on = {},
    ...
    p.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = p.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(cn, "$1" + i) : !1 !== t.jsonp && (t.url += (Ft.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
            ...
            void 0 === o ? p(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, un.push(i)), a && p.isFunction(o) && o(a[0]), a = o = void 0
        }), "script"
    ...
    p.fn.load = function(e, t, n) {
        ...
        setOffset: function(e, t, n) {
            var r, i, o, a, s, l, u = p.css(e, "position"),
                c = p(e),
                f = {};
            "static" === u && (e.style.position = "relative"), s = c.offset(), o = p.css(e, "top"), l = p.css(e, "left"), ("absolute" === u || "fixed" === u) && p.inArray("auto", [o, l]) > -1 ? (a = (r = c.position()).top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(l) || 0), p.isFunction(t) && (t = t.call(e, n, p.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + i), "using" in t ? t.using.call(e, f) : c.css(f)
        }
    }, p.fn.extend({
        offset: function(e) {
