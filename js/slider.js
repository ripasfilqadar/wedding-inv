...
! function(e, n) {
    ...
    e.fn.fullpage = function(Y) {
        function K(e) {
            e.find(F).after('<div class="' + X + '"></div><div class="' + _ + '"></div>'), "#fff" != Y.controlArrowColor && (e.find(G).css("border-color", "transparent transparent transparent " + Y.controlArrowColor), e.find(j).css("border-color", "transparent " + Y.controlArrowColor + " transparent transparent")), Y.loopHorizontal || e.find(j).hide()
        }

        function Q() {
            gn.append('<div id="' + A + '"><ul></ul></div>'), yn = e(L), yn.addClass(function() {
                return Y.showActiveTooltip ? B + " " + Y.navigationPosition : Y.navigationPosition
            });
            ...
            if (!Y.autoScrolling || Y.scrollBar) {
                if (!n.hasClass(g)) {
                    ...
                    if (m.length) var S = m.data("anchor"),
                        w = m.index();
                    En && (n.addClass(g).siblings().removeClass(g), e.isFunction(Y.onLeave) && Y.onLeave.call(f, u, v, h), e.isFunction(Y.afterLoad) && Y.afterLoad.call(n, p, v), we(n), Fe(p, v - 1), Y.anchors.length && (Sn = p, $e(w, S, p, v))), clearTimeout(zn), zn = setTimeout(function() {
                        Pn = !1
                    }, 100)
                }
                Y.fitToSection && (clearTimeout(In), In = setTimeout(function() {
                    En && (e(x).is(n) && (Ln = !0), he(n), Ln = !1)
                }, 1e3))
            }
        }

        function te(e) {
            return e.find(F).length ? e.find(I).find(r) : e.find(r)
        }
        ...
        function se(n, o) {
            o = o || 0;
            var t = e(n).parent();
            return o < Y.normalScrollElementTouchThreshold && t.is(Y.normalScrollElements) ? !0 : o == Y.normalScrollElementTouchThreshold ? !1 : se(t, ++o)
        }
        ...
        function pe(n) {
            if (Y.css3 && Y.autoScrolling && !Y.scrollBar) {
                ...
                We(o, !0), Y.scrollingSpeed ? setTimeout(function() {
                    Se(n)
                }, Y.scrollingSpeed) : Se(n)
            } else {
                var t = ve(n);
                e(t.element).animate(t.options, Y.scrollingSpeed, Y.easing).promise().done(function() {
                    Se(n)
                })
            }
        }
        ...
        function ve(e) {
            var n = {};
            return Y.autoScrolling && !Y.scrollBar ? (n.options = {
                top: -e.dtop
        ...
        function ge(n) {
            return n.isMovementUp ? e(x).before(n.activeSection.nextAll(y)) : e(x).after(n.activeSection.prevAll(y).get().reverse()), rn(e(x).position().top), ue(), n.wrapAroundElements = n.activeSection, n.dest = n.element.position(), n.dtop = n.dest.top, n.yMovement = De(n.element), n
        }

        function me(n) {
            n.wrapAroundElements && n.wrapAroundElements.length && (n.isMovementUp ? e(b).before(n.wrapAroundElements) : e(T).after(n.wrapAroundElements), rn(e(x).position().top), ue())
        }

        function Se(n) {
            me(n), n.element.find(".fp-scrollable").mouseover(), e.isFunction(Y.afterLoad) && !n.localIsResizing && Y.afterLoad.call(n.element, n.anchorLink, n.sectionIndex + 1), we(n.element), ye(n.element), En = !0, e.isFunction(n.callback) && n.callback.call(this)
        }

        function we(n) {
            n.find("img[data-src], video[data-src], audio[data-src]").each(function() {
        ...
        function Ce(n) {
            ...
            if (!o.is("textarea") && !o.is("input") && !o.is("select") && Y.keyboardScrolling && Y.autoScrolling) {
                var t = n.which,
                    i = [40, 38, 32, 33, 34];
                e.inArray(t, i) > -1 && n.preventDefault(), On = setTimeout(function() {
                    ke(n)
                }, 150)
            }
        }
        ...
        function Ae(e) {
            En && (e.pageY < Un ? mn.moveSectionUp() : e.pageY > Un && mn.moveSectionDown()), Un = e.pageY
        }
        ...
        function Le(n, o) {
            ...
            var v = function() {
                f || e.isFunction(Y.afterSlideLoad) && Y.afterSlideLoad.call(o, r, l + 1, d, a), bn = !1
            };
            if (Y.css3) {
                var S = "translate3d(-" + t.round(i.left) + "px, 0px, 0px)";
                Me(n.find(D), Y.scrollingSpeed > 0).css(cn(S)), setTimeout(function() {
                    v()
        ...
        function Ie(n, o) {
            Y.navigation && (e(L).find(m).removeClass(g), n ? e(L).find('a[href="#' + n + '"]').addClass(g) : e(L).find("li").eq(o).find("a").addClass(g))
        }

        function Pe(n) {
            Y.menu && (e(Y.menu).find(m).removeClass(g), e(Y.menu).find('[data-menuanchor="' + n + '"]').addClass(g))
        }
        ...
        function qe(e) {
            ...
            n > i ? t.length ? t.css("height", i + "px").parent().css("height", i + "px") : (Y.verticalCentered ? e.find(k).wrapInner('<div class="' + l + '" />') : e.wrapInner('<div class="' + l + '" />'), e.find(r).slimScroll({
                allowPageScroll: !0,
                height: i + "px",
                size: "10px",
                alwaysVisible: !0
        ...
        function Oe(e) {
            e.find(r).children().first().unwrap().unwrap(), e.find(c).remove(), e.find(d).remove()
        }

        function Ue(e) {
            e.addClass(V).wrapInner('<div class="' + C + '" style="height:' + Ye(e) + 'px;" />')
        }
        ...
        function We(e, n) {
            n ? Me(kn) : Re(kn), kn.css(cn(e)), setTimeout(function() {
                kn.removeClass(u)
            }, 10)
        }
        ...
        function Xe(e, n) {
            var o = Ne(e);
            "undefined" == typeof n && (n = 0), e === Sn || o.hasClass(g) ? je(o, n) : he(o, function() {
                je(o, n)
            })
        }
        ...
        function en() {
            o.addEventListener ? (o.removeEventListener("mousewheel", de, !1), o.removeEventListener("wheel", de, !1), o.removeEventListener("DOMMouseScroll", de, !1)) : o.detachEvent("onmousewheel", de)
        }

        function nn() {
            o.addEventListener ? (o.addEventListener("mousewheel", de, !1), o.addEventListener("wheel", de, !1), o.addEventListener("DOMMouseScroll", de, !1)) : o.attachEvent("onmousewheel", de)
        }
        ...
        function sn(e) {
            var n = [];
            return n.y = "undefined" != typeof e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, n.x = "undefined" != typeof e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, Cn && le(e) && (n.y = e.touches[0].pageY, n.x = e.touches[0].pageX), n
        }

        function ln(e, n) {
            mn.setScrollingSpeed(0, "internal"), "undefined" != typeof n && (Ln = !0), Le(e.closest(F), e), "undefined" != typeof n && (Ln = !1), mn.setScrollingSpeed(Rn.scrollingSpeed, "internal")
        }
        ...
        function fn() {
            rn(0), e(L + ", " + O + ", " + W).remove(), e(y).css({
                ...
                Oe(e(this)), e(this).removeClass(V + " " + g)
            }), Re(kn), kn.find(k + ", " + D + ", " + F).each(function() {
                e(this).replaceWith(this.childNodes)
            }), vn.scrollTop(0)
        }

        function un(e, n, o) {
            Y[e] = n, "internal" !== o && (Rn[e] = n)
        }
        ...
        }), mn.setAutoScrolling = function(n, o) {
            un("autoScrolling", n, o);
            var t = e(x);
            Y.autoScrolling && !Y.scrollBar ? (vn.css({
                overflow: "hidden",
                height: "100%"
            }), mn.setRecordHistory(Y.recordHistory, "internal"), kn.css({
                "-ms-touch-action": "none",
                "touch-action": "none"
            }), t.length && rn(t.position().top)) : (vn.css({
                overflow: "visible",
                height: "initial"
            }), mn.setRecordHistory(!1, "internal"), kn.css({
                "-ms-touch-action": "",
                "touch-action": ""
            }), rn(0), t.length && vn.scrollTop(t.position().top))
        }, mn.setRecordHistory = function(e, n) {
            un("recordHistory", e, n)
        }, mn.setScrollingSpeed = function(e, n) {
            un("scrollingSpeed", e, n)
        }, mn.setFitToSection = function(e, n) {
            un("fitToSection", e, n)
        }, mn.setLockAnchors = function(e) {
            Y.lockAnchors = e
        }, mn.setMouseWheelScrolling = function(e) {
            e ? nn() : en()
        }, mn.setAllowScrolling = function(n, o) {
            "undefined" != typeof o ? (o = o.replace(/ /g, "").split(","), e.each(o, function(e, o) {
                dn(n, o, "m")
            })) : n ? (mn.setMouseWheelScrolling(!0), on()) : (mn.setMouseWheelScrolling(!1), tn())
        }, mn.setKeyboardScrolling = function(n, o) {
            "undefined" != typeof o ? (o = o.replace(/ /g, "").split(","), e.each(o, function(e, o) {
                dn(n, o, "k")
            })) : Y.keyboardScrolling = n
        }, mn.moveSectionUp = function() {
            var n = e(x).prev(y);
        ...
        }, mn.silentMoveTo = function(e, n) {
            mn.setScrollingSpeed(0, "internal"), mn.moveTo(e, n), mn.setScrollingSpeed(Rn.scrollingSpeed, "internal")
        }, mn.moveTo = function(e, n) {
            var o = Ne(e);
            "undefined" != typeof n ? Xe(e, n) : o.length > 0 && he(o)
        }, mn.moveSlideRight = function() {
            fe("next")
        }, mn.moveSlideLeft = function() {
            fe("prev")
        }, mn.reBuild = function(n) {
            if (!kn.hasClass(h)) {
                Ln = !0;
                var o = J.width();
                An = J.height(), Y.resize && ze(An, o), e(y).each(function() {
                    var n = e(this).find(F),
                        o = e(this).find(z);
                    Y.verticalCentered && e(this).find(k).css("height", Ye(e(this)) + "px"), e(this).css("height", An + "px"), Y.scrollOverflow && (o.length ? o.each(function() {
                        qe(e(this))
                    }) : qe(e(this))), o.length > 1 && Le(n, n.find(I))
                });
                var t = e(x),
                    i = t.index(y);
        ...
        var Rn = e.extend(!0, {}, Y);
        e(this).length ? (kn.css({
            height: "100%",
            position: "relative"
        }), kn.addClass(a), e("html").addClass(p)) : pn("error", "Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();"), Y.css3 && (Y.css3 = Ze()), mn.setAllowScrolling(!0), kn.removeClass(h), e(Y.sectionSelector).each(function() {
            e(this).addClass(w)
        }), e(Y.slideSelector).each(function() {
            e(this).addClass(R)
        }), Y.navigation && Q(), e(y).each(function(n) {
            var o = e(this),
                t = e(this).find(z),
                i = t.length;
            if (n || 0 !== e(x).length || e(this).addClass(g), e(this).css("height", An + "px"), Y.paddingTop && e(this).css("padding-top", Y.paddingTop), Y.paddingBottom && e(this).css("padding-bottom", Y.paddingBottom), "undefined" != typeof Y.sectionsColor[n] && e(this).css("background-color", Y.sectionsColor[n]), "undefined" != typeof Y.anchors[n] && (e(this).attr("data-anchor", Y.anchors[n]), e(this).hasClass(g) && Fe(Y.anchors[n], n)), i > 0) {
                var a = 100 * i,
                    s = 100 / i;
                t.wrapAll('<div class="' + H + '" />'), t.parent().wrap('<div class="' + P + '" />'), e(this).find(D).css("width", a + "%"), i > 1 && (Y.controlArrows && K(e(this)), Y.slidesNavigation && Qe(e(this), i)), t.each(function(n) {
                    e(this).css("width", s + "%"), Y.verticalCentered && Ue(e(this))
                });
                var l = o.find(I);
        ...
        var Fn = 0,
            ...
            Vn = 0,
            qn = (new Date).getTime();
        J.on("hashchange", Te), Z.keydown(Ce), Z.keyup(function(e) {
            xn = e.ctrlKey
        }), e(n).blur(function() {
            xn = !1
        });
        ...
        kn.mousedown(function(e) {
            2 == e.which && (Un = e.pageY, kn.on("mousemove", Ae))
        ...
        Z.on("click touchstart", L + " a", function(n) {
            ...
            Le(o, t)
        }), Y.normalScrollElements && (Z.on("mouseenter", Y.normalScrollElements, function() {
            mn.setMouseWheelScrolling(!1)
        }), Z.on("mouseleave", Y.normalScrollElements, function() {
            mn.setMouseWheelScrolling(!0)
        })), e(y).on("click touchstart", W, function() {
            e(this).hasClass(N) ? Mn.m.left && mn.moveSlideLeft() : Mn.m.right && mn.moveSlideRight()
        }), J.resize(Ee);
        var Yn, Wn = An;
        mn.destroy = function(n) {
            mn.setAutoScrolling(!1, "internal"), mn.setAllowScrolling(!1), mn.setKeyboardScrolling(!1), kn.addClass(h), J.off("scroll", oe).off("hashchange", Te).off("resize", Ee), Z.off("click", L + " a").off("mouseenter", L + " li").off("mouseleave", L + " li").off("click", U).off("mouseover", Y.normalScrollElements).off("mouseout", Y.normalScrollElements), e(y).off("click", W), n && fn()
        }
    }
});
...
! function(e, t, n, o, i) {
    e.fn.multiscroll = function(s) {
        ...
        function g(e) {
            ...
            return K || (0 > n ? X.moveSectionDown() : X.moveSectionUp()), !1
        }
        ...
        e(n).mousedown(function(e) {
            ...
            !t.length && s.loopTop && (t = e(".ms-left .ms-section").last()), t.length && v(t)
        }, X.moveSectionDown = function() {
            var t = e(".ms-left .ms-section.active").next(".ms-section");
            !t.length && s.loopBottom && (t = e(".ms-left .ms-section").first()), t.length && v(t)
        }, X.moveTo = function(t) {
            var n = "";
