...
! function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        if (YTPlayer.opt.optimizeDisplay) {
            ...
            lowest && (vid.height = win.height, vid.width = Math.ceil(vid.height * YTPlayer.opt.ratio), vid.marginTop = 0, vid.marginLeft = Math.ceil(-((vid.width - win.width) / 2))), console.debug("vid.marginTop    ", vid.marginTop), console.debug("vid.marginLeft    ", vid.marginLeft), console.debug("vid.width    ", vid.width), console.debug("vid.height  ", vid.height);
...
/*
Vimeo API jQuery Plugin
The MIT License
Copyright (c) 2014-2015 Jeremy Rue
*/
! function(e, t) {
    var a = {
            catchMethods: {
        ...
        r = e.fn.vimeoLoad = function() {
            ...
            if (null === t.match(/player_id/g)) {
                ...
                e(this).attr("src", t + a + r)
            }
            return this
        };
    jQuery(document).ready(function() {
        e("iframe[src*='vimeo.com']").each(function() {
            r.call(this)
        })
